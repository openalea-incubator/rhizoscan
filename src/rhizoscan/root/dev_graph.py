...
def sinput(rgraph):
    """
    ginput like, that returns the segment id closest to click position
    """
    from matplotlib import pyplot as plt
...
def _segdist_env(rgraph):
    ...
    start = pos[:,:,0]                # position of first segment node
    edge  = pos[...,1]-pos[...,0]     # vector from 1st node to 2nd
